...
dev_angles = np.linspace(1.7,3.1,15)
print dev_angles

filename = 'Glass_worksheet1.txt'
...
for angle in dev_angles:
	...
	table.add_row([material, nd, abbe_num, T, np.round(angle,4), np.round(beta,4), Diameter, T_edge, wedge_rad, B, C, H,Manu, Prism])
...
ascii.write(table,output=filename,overwrite=True)
